    ...
    return (
        <section className="py-24 px-6 sm:px-12 bg-white dark:bg-black border-t border-zinc-100 dark:border-zinc-900">
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-900 dark:text-white mb-8 leading-tight">
                ...
                <div className="flex flex-col items-center gap-12">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 uppercase tracking-widest px-4">
